...
My work was based on and expanded the research presented in this work by [Chalkis et al.](https://arxiv.org/abs/2010.03817). I focused on fixing numerical linear algebra errors, improving the performance of the SDP solver, all while adding support for sparse problems, and a preprocessing algorithm called Sieve-SDP. Overall, my contributions significantly enhanced the performance and robustness of the SDP solver, advancing the VolEsti library's capabilities in semidefinite programming.
